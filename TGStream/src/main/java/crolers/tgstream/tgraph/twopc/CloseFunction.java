...
import crolers.tgstream.tgraph.durability.LocalWALServer;
...
/**
 * Created by crolers
 * close operator, collect the Metadata outcome of elements and obtain transactionResult
 */
public class CloseFunction extends RichFlatMapFunction<Metadata, TransactionResult>
    ...
    //Transform Metadata to TransactionResult which has 5 fields mentioned in the article
    @Override
